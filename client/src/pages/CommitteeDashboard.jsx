...
export default function CommitteeDashboard() {
  ...
  const loadFaults = async () => {
    ...
    try {
      ...
      setError("לא הצלחנו לטעון תקלות. ודא שיש הרשאת committee וששרת רץ.");
    } finally {
      setLoading(false);
    }
  };
  ...
  if (loading)
    return <div className="min-h-screen p-6 bg-gray-100">טוען...</div>;

  return (
    <div className="min-h-screen p-6 bg-gray-100 text-gray-800">
      <div className="flex items-center justify-between mb-4">
        <h1 className="text-3xl font-bold">ועד – ניהול תקלות</h1>
        <button
          onClick={loadFaults}
